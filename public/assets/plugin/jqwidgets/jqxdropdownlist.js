...
(function(a) {
    ...
    a.extend(a.jqx._jqxDropDownList.prototype, {
        ...
        render: function() {
            ...
            q.addHandler(q.dropdownlistWrapper, "selectstart",
            function() {
                return false
            });
            ...
            try {
                ...
                q.addHandler(q.listBoxContainer, "bindingComplete",
                function(e) {
                    if (!q.listBox) {
                ...
                q.addHandler(q.listBoxContainer, "unselect",
                function(e) {
                    q._raiseEvent("3", {
                        index: e.args.index,
                        type: e.args.type,
                ...
                q.addHandler(q.listBoxContainer, "change",
                function(e) {
                    if (e.args) {
        ...
        _updateHandlers: function() {
            ...
            if (this.host.parents()) {
                this.addHandler(this.host.parents(), "scroll.dropdownlist" + this.element.id,
                function(e) {
                    var f = c.isOpened();
                    if (f) {
                        c.close()
            ...
            this.addHandler(this.dropdownlistWrapper, b,
            function(f) {
                if (!c.disabled) {
            ...
            this.addHandler(this._firstDiv, "focus",
            function(e) {
                if (c.renderMode !== "simple") {
                    c.host.addClass(c.toThemeProperty("jqx-dropdownlist-state-focus"));
                    c.host.addClass(c.toThemeProperty("jqx-fill-state-focus"))
            ...
            this.addHandler(this._firstDiv, "blur",
            function() {
                if (c.renderMode !== "simple") {
                    c.host.removeClass(c.toThemeProperty("jqx-dropdownlist-state-focus"));
                    c.host.removeClass(c.toThemeProperty("jqx-fill-state-focus"))
